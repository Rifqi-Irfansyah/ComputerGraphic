...
class Ironman:
    ...
    def gambar_ironman(self):
        ...
        points_tanganKanan = self.rotate(points_tanganKiri, self.xc, self.yc-63, 180)

        points_tanganKiri = self.rotate(points_tanganKiri, self.xc-35, self.yc-60, 60)
        points_tanganKanan = self.rotate(points_tanganKanan, self.xc+35, self.yc-60, -60)
        ...
        cetak_point(self.pointsApi, config.BLUE)
